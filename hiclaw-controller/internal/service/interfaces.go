...
type WorkerDeployer interface {
	...
	PushOnDemandSkills(ctx context.Context, workerName, runtime string, skills []string, remoteSkills []v1beta1.RemoteSkillSource) error
...
type ManagerDeployer interface {
	...
	PushOnDemandSkills(ctx context.Context, name, runtime string, skills []string, remoteSkills []v1beta1.RemoteSkillSource) error
